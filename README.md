...
As the part of the system created in [BusinessAppMaker](https://github.com/neel1998/BusinessAppMaker) service, this repository contains the code for the template android application for the customer side of the business in the service.
